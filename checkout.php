...
<body>
			...
			<table>
				<form action="process_register.php" method="POST">   / freshdesignweb top bar 2 linesjdkdjcjkndcj-->
      ...
      <div  class="form">
            ...
            <a href="payment_details.php"><input class="buttom" name="submit" id="submit" tabindex="5" value="Confirm & Proceed" type="submit"> </a>	 
   </form> 
</div>      
</div>
</body>